...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.ProductPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductPkgItemProvider extends NamedItemItemProvider {
  /**
   ...
   * @generated
   */
  public ProductPkgItemProvider(AdapterFactory adapterFactory) {
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ProductPkg"));
  }
  ...
  public String getText(Object object) {
    String label = ((ProductPkg)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_ProductPkg_type") :
      getString("_UI_ProductPkg_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(ProductPkg.class)) {
