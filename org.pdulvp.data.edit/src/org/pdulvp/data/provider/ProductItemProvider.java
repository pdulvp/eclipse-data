...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.Product} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductItemProvider extends NamedItemItemProvider {
  /**
  ...
  protected void addParentPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Product_parent_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Product_parent_feature", "_UI_Product_type"),
         DataPackage.Literals.PRODUCT__PARENT,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(DataPackage.Literals.PRODUCT__OWNED_PRODUCTS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (DataPackage.Literals.PRODUCT__OWNED_PRODUCTS,
