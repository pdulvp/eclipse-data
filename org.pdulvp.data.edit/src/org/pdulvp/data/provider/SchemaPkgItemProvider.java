...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.SchemaPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaPkgItemProvider extends AbstractItemItemProvider {
  /**
   ...
   * @generated
   */
  public SchemaPkgItemProvider(AdapterFactory adapterFactory) {
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/SchemaPkg"));
  }
  ...
  public String getText(Object object) {
    String label = ((SchemaPkg)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_SchemaPkg_type") :
      getString("_UI_SchemaPkg_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(SchemaPkg.class)) {
