...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.CategoryPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryPkgItemProvider extends NamedItemItemProvider {
  /**
   ...
   * @generated
   */
  public CategoryPkgItemProvider(AdapterFactory adapterFactory) {
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/CategoryPkg"));
  }
  ...
  public String getText(Object object) {
    String label = ((CategoryPkg)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_CategoryPkg_type") :
      getString("_UI_CategoryPkg_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(CategoryPkg.class)) {
