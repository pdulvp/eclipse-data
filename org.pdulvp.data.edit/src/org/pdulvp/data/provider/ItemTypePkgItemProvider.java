...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.ItemTypePkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemTypePkgItemProvider extends NamedItemItemProvider {
  /**
   ...
   * @generated
   */
  public ItemTypePkgItemProvider(AdapterFactory adapterFactory) {
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ItemTypePkg"));
  }
  ...
  public String getText(Object object) {
    String label = ((ItemTypePkg)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_ItemTypePkg_type") :
      getString("_UI_ItemTypePkg_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(ItemTypePkg.class)) {
