...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.ItemPkg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemPkgItemProvider extends NamedItemItemProvider {
	/**
   ...
   * @generated
   */
	public ItemPkgItemProvider(AdapterFactory adapterFactory) {
   ...
   */
    ...
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ItemPkg"));
  }
   ...
   */
    ...
    String label = ((ItemPkg)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_ItemPkg_type") :
      getString("_UI_ItemPkg_type") + " " + label;
  }
   ...
   */
    ...
    switch (notification.getFeatureID(ItemPkg.class)) {
