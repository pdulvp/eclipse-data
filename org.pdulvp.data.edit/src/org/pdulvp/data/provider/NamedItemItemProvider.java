...
/**
 * This is the item provider adapter for a {@link org.pdulvp.data.NamedItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedItemItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
   ...
   * @generated
   */
	public NamedItemItemProvider(AdapterFactory adapterFactory) {
   ...
   */
    ...
    String label = ((NamedItem)object).getName();
    return label == null || label.length() == 0 ?
      getString("_UI_NamedItem_type") :
      getString("_UI_NamedItem_type") + " " + label;
  }
   ...
   */
    ...
    switch (notification.getFeatureID(NamedItem.class)) {
