...
public class DataActionBarContributor
   ...
   */
	protected IAction showPropertiesViewAction =
		new Action(DataEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
      @Override
      public void run() {
        try {
   ...
   */
	protected IAction refreshViewerAction =
		new Action(DataEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
      @Override
   ...
   */
    ...
    IMenuManager submenuManager = new MenuManager(DataEditorPlugin.INSTANCE.getString("_UI_DataEditor_menu"), "org.pdulvp.dataMenuID");
   ...
   */
    ...
    submenuManager = new MenuManager(DataEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    populateManager(submenuManager, createChildActions, null);
    menuManager.insertBefore("edit", submenuManager);

    submenuManager = new MenuManager(DataEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
